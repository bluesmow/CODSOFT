...
class calculator:
    def __init__(self):
        ...
        self.create_digit_buttons_buttons()
    ...
    def create_display_labels(self):
        total_label = tk.Label(self.display_frame, text=self.current_expression, anchor = tk.E,bg = LIGHT_GREY, fg =LABEL_COLOR,padx=24,font=SMALL_FONT_STYLE)
        total_label.pack(expand=True,fill='both')

        label = tk.Label(self.display_frame, text=self.total_expression, anchor = tk.E,bg = LIGHT_GREY, fg =LABEL_COLOR,padx=24,font=LARGE_FONT_STYLE)
    ...
    def create_digit_buttons_buttons(self):
